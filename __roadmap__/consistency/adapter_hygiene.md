...
**Pre-conditions**:
- [ ] Working in worktree `/Users/me/worktrees/colgrep-mcp/task-adapter_hygiene` on branch `task/adapter_hygiene` (created by the lead from the campaign branch); this file exists there — if it does not, stop and report
