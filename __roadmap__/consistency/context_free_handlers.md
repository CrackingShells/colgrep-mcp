...
**Pre-conditions**:
- [ ] Working in worktree `/Users/hacker/Documents/tmp/claude-worktrees/colgrep_mcp/task-context_free_handlers` on branch `task/context_free_handlers` (created by the lead from the campaign branch); this file exists there — if it does not, stop and report
