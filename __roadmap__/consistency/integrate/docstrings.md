...
**Pre-conditions**:
- [ ] Working in worktree `/Users/hacker/Documents/tmp/claude-worktrees/colgrep_mcp/task-docstrings` on branch `task/docstrings` (created by the lead from the campaign branch **after** the four depth-0 leaves merged); this file exists there — if it does not, stop and report
