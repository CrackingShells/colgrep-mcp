...
- ✅ [run] `git tag` lists `v0.1.1`; `git -C /Users/hacker/Documents/explore/colgrep_mcp log --oneline -1` shows `release(colgrep-mcp): v0.1.1`
...
**Consistency Checks**: `git -C /Users/hacker/Documents/explore/colgrep_mcp tag --points-at HEAD` (expected: `v0.1.1`); `cd /Users/hacker/Documents/explore/colgrep_mcp/server && uv run pytest -q` (expected: PASS)
