...
**Pre-conditions**:
- [ ] `server_assembly` merged; real `colgrep` on PATH; a real corpus available: clone `https://github.com/pallets/click` shallowly into `~/colgrep-e2e-corpus/click` — NOT under `/private/tmp` (R05 D3: a shared colgrep project is rooted there)
**Success Gates**:
