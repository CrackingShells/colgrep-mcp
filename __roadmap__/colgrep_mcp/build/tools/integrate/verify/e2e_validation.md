...
**Pre-conditions**:
- [ ] `server_assembly` merged; real `colgrep` on PATH; a real corpus available (clone `https://github.com/pallets/click` shallowly into the scratchpad, or reuse the R03 corpus)
**Success Gates**:
