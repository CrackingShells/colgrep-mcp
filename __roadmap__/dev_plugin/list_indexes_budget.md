...
**Pre-conditions**:
- [ ] Working in worktree `/Users/me/worktrees/colgrep-mcp/task-list_indexes_budget` on branch `task/list_indexes_budget` (created by the lead from the campaign branch); this file exists there — if it does not, stop and report
