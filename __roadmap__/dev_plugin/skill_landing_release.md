...
**Pre-conditions**:
- [ ] Working in worktree `/Users/me/worktrees/colgrep-mcp/task-skill_landing_release` on branch `task/skill_landing_release` (created by the lead from the campaign branch); this file exists there — if it does not, stop and report
