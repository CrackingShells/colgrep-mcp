...
**Pre-conditions**:
- [ ] Working in worktree `/Users/hacker/Documents/tmp/claude-worktrees/colgrep_mcp/task-skill_policy` on branch `task/skill_policy` (created by the lead from the campaign branch); this file exists there — if it does not, stop and report
