...
- Scratchpad probes used to confirm F1–F5 empirically: `/private/tmp/scratchpad/probe_cancel.py`, `probe_index_build_cancel.py` (not part of the repo; reproduced below)
