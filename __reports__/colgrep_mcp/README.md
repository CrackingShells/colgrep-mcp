...
## Status
Campaign bootstrapped 2026-09-11. Architecture v0 by the team lead; round-01 findings by research agents. Round-02: architecture delta, clean real-binary e2e validation, and a code review whose bug findings are being fixed before the 0.1.0 release.
