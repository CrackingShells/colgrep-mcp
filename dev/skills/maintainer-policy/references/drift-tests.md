...
| `tests/test_readme.py` | The tool names listed in `README.md`'s table match the tools the server actually registers — a renamed or removed tool that isn't updated in the README fails here instead of shipping stale docs. |
